...
/**
 * useQuizNavigation - Question traversal + UI chrome state
 * Takes state/dispatch from quiz core
 * Returns: { uniqueIndices, totalQuestions, displayIndex, hasReachedLastQuestion, handleSkip, handleGoBack, goToNextUnanswered, showMenu, isMobile, mobileOpen, setMobileOpen }
 */
